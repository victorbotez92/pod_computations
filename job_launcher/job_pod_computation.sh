...
data_directory="/gpfs/users/botezv/APPLICATIONS_POD/job_launcher/data_example.txt"

echo 'running pod'
# srun python /gpfs/users/botezv/APPLICATIONS_POD/pod_computations_test_angle_shift_v3/initialization.py "$data_directory"
srun python /gpfs/users/botezv/APPLICATIONS_POD/pod_computations_parallelize_on_D/initialization.py "$data_directory"
