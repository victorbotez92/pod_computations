...
class parameters:
    def __init__(self,list_ints,elms_ints,list_several_ints,elms_lists_ints,list_floats,elms_floats,list_bools,
                                elms_bools,list_chars,elms_chars,list_several_chars,elms_lists_chars):
...
def global_parameters(data_file,list_ints,list_several_ints,list_floats,list_bools,list_chars,list_several_chars):
        ...
        if '===' in line:
            ...
            if new_name in list_several_chars:
                ...
                if new_name in  list_ints:
                    ...
                    globals()[new_param] = float(new_param)
    ...
    all_parameters = parameters(list_ints,elms_ints,list_several_ints,elms_lists_ints,list_floats,elms_floats,
                                list_bools,elms_bools,list_chars,elms_chars,list_several_chars,elms_lists_chars)
